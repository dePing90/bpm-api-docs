...
#. Перейдите по ссылке: https://xcom.kontur.ru и авторизуйтесь. Система автоматически подставит название пространства на латинице.
#. Если пространств несколько, то выберите нужное из списка: https://xcom.kontur.ru/workspaces. Если одно — пропустите этот пункт.
#. Измените адрес в строке браузера и перейдите по ссылке: https://xcom.kontur.ru/api/имя_пространства/private-integrations; где:
