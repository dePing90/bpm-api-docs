...
При помощи этого метода Контур.CRM делает вызов, когда пользователь нажимает кнопку «Позвонить» в интерфейсе. 
В интеграции должна быть включена функциональность ``CALL`` и ``HANGUP``. 
Подробнее в разделе: "Включение системных вызовов"
...
При помощи этого метода Контур.CRM делает вызов, 
когда пользователь нажимает кнопку «Положить трубку» в интерфейсе. 
В интеграции должна быть включена функциональность  ``CALL`` и ``HANGUP``.
